...
def _drop_regenerated_condition_embedding_weights(
    ...
    *,
    ...
    removed_keys = sorted(set(model_state.keys()) - set(filtered_state.keys()))
    return filtered_state, removed_keys
...
def main() -> None:
    ...
    try:
        pretrain_config = load_yaml_config(args.sfm_pretrain_config)
        ...
        if model_state is not None:
            filtered_model_state, removed_keys = _drop_regenerated_condition_embedding_weights(
                model_state,
