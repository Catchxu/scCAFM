...
def test_flash_attn_func():
    ...
    print("[FA4] flash_attn_func passed")


def test_flash_attn_varlen_func():
    print("\n[FA4] Testing flash_attn_varlen_func")
    ...
    print("[FA4] flash_attn_varlen_func passed")
...
if __name__ == "__main__":
    ...
    print("\nFA4 flash_attn_func + flash_attn_varlen_func demo passed.")